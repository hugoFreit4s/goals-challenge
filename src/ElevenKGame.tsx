...
function ElevenKGame({ setPickedPlayersArr, getPlayer, currentPlayer }: ButtonProps) {
    return (
        <div className="game_buttons" style={{ display: 'flex', flexDirection: 'column', gap: '20px', width: '300px' }}>
            ...
            {generateButton(5, setPickedPlayersArr, getPlayer, currentPlayer)}
        </div>
    )
}

export default ElevenKGame;